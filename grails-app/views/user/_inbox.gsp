    ...
    <div class="col-lg-9">
        ...
        <div>
            ...
            <g:if test="${linksharingapp.Resource.findTypeOfResource(unReadResource.resource.id) == "DocumentResource"}">
                <div class="col-lg-4">
                    <a href="${createLink(controller: "documentResource", action: "show", id: "${unReadResource.resource.id}")}"
                       class="text-primary" style="text-decoration: underline;" target="_blank">Download</a>
                </div>
            </g:if>

            <g:else>
                <div class="col-lg-4">
                    <a href="${unReadResource.resource.url}" target="_blank" class="text-primary"
            ...
            <div class="col-lg-2">
                <a href="${createLink(controller: 'resource', action: 'show', id: unReadResource.resource.id)}"
